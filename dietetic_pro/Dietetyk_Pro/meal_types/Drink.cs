...
namespace DietetykPro
{
    ...
    public class Drink : Product
    {
        ...
        public Drink(int product_id, string product_name, double caloricity, double carbohydrate, double protein, double fat) : base(product_id, product_name, caloricity, carbohydrate, protein, fat)
        {
            _type = 6;
        }
        ...
        public override void Print_Product()
        {
            ...
            Console.WriteLine("Kategoria: Napoje");
        }
    }
}
