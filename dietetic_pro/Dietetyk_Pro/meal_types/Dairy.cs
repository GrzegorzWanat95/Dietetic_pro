...
namespace DietetykPro
{
    ...
    public class Dairy : Product
    {
        ...
        public Dairy(int product_id, string product_name, double caloricity, double carbohydrate, double protein, double fat) : base(product_id, product_name, caloricity, carbohydrate, protein, fat)
        {
            _type = 4;
        }
        ...
        public override void Print_Product()
        {
            ...
            Console.WriteLine("Kategoria: Nabiał");
        }

        public override void Product_Restriction()
        {
            Console.WriteLine("Produkt {0} zawiera laktozę.", base.Product_name);
        }
    }
}
