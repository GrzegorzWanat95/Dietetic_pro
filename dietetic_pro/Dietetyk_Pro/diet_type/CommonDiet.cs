...
namespace DietetykPro
{
    public class CommonDiet:Diet
    {
        ...
        public CommonDiet(int _diet_id, int _meal_number, int patient_id) : base(_diet_id, _meal_number, patient_id)
        {
            this._type = 1;
        }
        ...
        public override void Diet_Report(Diet diet, int patient_id, List<Patient> patient_base)
        {
            ...
            if (caloricity >= 0)
            {
                ...
                Console.WriteLine();
                Console.WriteLine("---Dieta ogólna---");
            }
        }
    }
}
